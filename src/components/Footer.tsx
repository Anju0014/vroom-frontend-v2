    ...
    <footer className="bg-gray-900 text-white p-8">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-sm text-gray-300">
              The most trusted car rental platform with a mission to provide convenient and affordable mobility solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white text-sm">Safety Center</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white text-sm">Accessibility</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-6">
          <p className="text-sm text-gray-400">© 2025 Vroom. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
